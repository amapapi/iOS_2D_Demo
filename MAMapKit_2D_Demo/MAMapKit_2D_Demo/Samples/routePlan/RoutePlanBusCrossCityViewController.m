//
//  RoutePlanBusCrossCityViewController.m
//  MAMapKit_2D_Demo
//
...
#import "RoutePlanBusCrossCityViewController.h"
...
@interface RoutePlanBusCrossCityViewController ()<MAMapViewDelegate, AMapSearchDelegate>
/* 路径规划类型 */
...
@implementation RoutePlanBusCrossCityViewController
...
- (void)viewDidLoad
{
    ...
    self.startCoordinate        = CLLocationCoordinate2DMake(40.818311, 111.670801);
    self.destinationCoordinate  = CLLocationCoordinate2DMake(44.433942, 125.184449);
...
- (void)detailAction
{
    ...
    [self gotoDetailForRoute:self.route type:AMapRoutePlanningTypeBus];
}

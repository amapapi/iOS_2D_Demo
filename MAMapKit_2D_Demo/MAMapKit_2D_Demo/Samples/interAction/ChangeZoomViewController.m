...
#import "ChangeZoomViewController.h"


@interface ChangeZoomViewController ()<MAMapViewDelegate>

@property (nonatomic, strong) MAMapView *mapView;

@end

@implementation ChangeZoomViewController
